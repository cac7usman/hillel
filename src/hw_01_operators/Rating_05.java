...
public class Rating_05 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(person1.getName() + " " + person1.getSurname() + " - " + Rating_05.getMarks(person1.getMark()));
        System.out.println(person2.getName() + " " + person2.getSurname() + " - " + Rating_05.getMarks(person2.getMark()));
        System.out.println(person3.getName() + " " + person3.getSurname() + " - " + Rating_05.getMarks(person3.getMark()));
