...
public class HW_02_03_09_BubbleSortTest
{
	...
	@Test(expected = IllegalArgumentException.class)
	public void testBubbleSort_00_01()
	{
		int[] array = {};
		HW_02_03_09_BubbleSort.BubbleSort(array);
	}
	...
	@Test
	public void testBubbleSort_01_01()
	{
		int[] array = { 1 };
		HW_02_03_09_BubbleSort.BubbleSort(array);
	...
	@Test
	public void testBubbleSort_01_02()
	{
		int[] array = { 100, 1 };
		HW_02_03_09_BubbleSort.BubbleSort(array);
	...
	@Test
	public void testBubbleSort_01_03()
	{
		int[] array = { 3, 100, 1 };
		HW_02_03_09_BubbleSort.BubbleSort(array);
		assertArrayEquals(new int[] { 1, 3, 100 }, array);
	}
