...
public class HW_02_01_04Test
{

	@Test
	public void testGetMax_01()
	{
		int c = HW_02_01_04.getMax(1, 1, 1);
		assertEquals(6, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(0, 0, 0);
		assertEquals(3, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(0, 0, 1);
		assertEquals(4, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(0, 1, 1);
		assertEquals(5, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(0, -1, 0);
		assertEquals(3, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(-1, -1, 4);
		assertEquals(7, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(-1, 1, -2);
		assertEquals(5, c);
	}
	...
	{
		int c = HW_02_01_04.getMax(-2, 2, 2);
		assertEquals(5, c);
	}
