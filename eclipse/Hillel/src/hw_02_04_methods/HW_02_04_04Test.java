...
public class HW_02_04_04Test
{

	@Test
	public void testGetDistance_01()
	{
		double test = HW_02_04_04.getDistance(0, 0, 0, 0);
	...
	{
		double test = HW_02_04_04.getDistance(0, 1, 0, 0);
	...
	{
		double test = HW_02_04_04.getDistance(0, 0, 1, 1);
	...
	{
		double test = HW_02_04_04.getDistance(1, 0, 0, 1);
		assertEquals(1.414, test, 0.015);
	}
	...
	{
		double test = HW_02_04_04.getDistance(0, 1, 1, 1);
		assertEquals(1.0, test, 0.01);
	}
	...
	{
		double test = HW_02_04_04.getDistance(1, 1, 1, 0);
		assertEquals(1.0, test, 0.01);
	}
	...
	{
		double test = HW_02_04_04.getDistance(1, 1, 1, 1);
		assertEquals(0, test, 0);
	}
	...
	{
		double test = HW_02_04_04.getDistance(-1, 1, 0, 0);
		assertEquals(1.414, test, 0.015);
	}
	...
	{
		double test = HW_02_04_04.getDistance(-1, 0, 1, 0);
		assertEquals(2.0, test, 0);
	}
	...
	{
		double test = HW_02_04_04.getDistance(-2, -2, 2, 2);
	...
	{
		double test = HW_02_04_04.getDistance(2, 4, 6, 8);
		assertEquals(5.656, test, 0.6);
	}
	...
	{
		double test = HW_02_04_04.getDistance(8, 6, 4, 2);
		assertEquals(5.656, test, 0.6);
	}
